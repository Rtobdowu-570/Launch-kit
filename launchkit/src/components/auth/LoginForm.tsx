  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-5">
      ...
      <button
        type="button"
        disabled={loading}
        className="w-full px-6 py-3 text-base font-medium bg-white text-gray-700 border border-gray-300 rounded-xl hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-3"
      >
